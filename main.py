...
def start_keyboard():
    ...
    keyboard.row(
        InlineKeyboardButton("ＣＨＡＮＮＥＬ", url="https://t.me/+f1M9zjM7oJw0ZDY1"),
        InlineKeyboardButton("ＯＷＮＥＲ", url="https://t.me/+f1M9zjM7oJw0ZDY1")
    )
    return keyboard
...
def start_command(message):
    ...
    caption = (
        ...
        "𝐂𝐑𝐄𝐀𝐓𝐎𝐑:- [𓍯𝙎𝙪𝙟𝙖𝙡⚝](https://t.me/+f1M9zjM7oJw0ZDY1)"
    )
